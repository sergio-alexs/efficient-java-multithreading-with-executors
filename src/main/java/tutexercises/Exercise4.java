 ...
 * Este programa es similar al Ejercicio 2, pero aumenta la carga a 5000 tareas.
 * Prueba el rendimiento de un ExecutorService con un pool de hilos en caché bajo una carga mayor.
 */
public class Exercise4 {

    public static void main(String[] args) {
        System.out.println("====================================");
        System.out.println(" CACHED THREAD POOL TEST (5000 TASKS)");
        System.out.println("====================================");
